...
<html>
	<head>
		...
		<style>
			.imagesWrap {
				background:url(img/itinerary/billboard/Germany-Switzerland-Austria.jpg)  center center no-repeat;
			...
			<div class="site">
				<div class="tourInfo">
					...
					<div class="transparentTxt">
						...
						<div class="tourName">原味欧洲，古堡奇幻之旅</div>
			...
			<div class="itineraryInfo">
				...
				<div class="flex-row-start-around itineraryHighLights">
					...
					<div class="flex1 hightLight">
						<h4>行程亮点</h4>
						<p>
							近距离走进卢塞恩湖畔村庄，将阿尔卑斯山美景尽收眼底<br/>
							游览海德堡的高耸城堡和萨尔茨堡中世纪堡垒<br/>
							进入新天鹅堡参观<br/>
							感受因斯布鲁克新旧城区的完美融合<br/>
							品尝慕尼黑小麦啤酒和白肠<br/>
							参观维也纳新艺术派建筑<br/>
		...
		<div class="site">
			...
			<div class="itineraryIntro section">
				...
				<div class="itineraryMap">
					<img src="http://travelplus.ef.com.cn/sp/img/itinerary/map/germany-switzerland-austria.jpg"  />
				</div>
