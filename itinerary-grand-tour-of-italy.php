...
<html>
	<head>
		...
		<style>
			.imagesWrap {
				background:url(img/itinerary/billboard/Grand-Tour-of-Italy.jpg)  center center no-repeat;
			...
			<div class="site">
				<div class="tourInfo">
					...
					<div class="transparentTxt">
						...
						<div class="tourName">意大利全景深度游</div>
				...
				<div class="swiper-wrapper">
					<div class="swiper-slide">
						<div class="swiperBgWrap">
							<div class="slideBg">
								<img src="http://travelplus.ef.com.cn/sp/img/itinerary/grand-tour-of-italy/1.jpg" />
							</div>
							<div class="bgIntro">
								<div class="transparentBg"></div>
					...
					<div class="swiper-slide">
						<div class="swiperBgWrap">
							<div class="slideBg">
								<img src="http://travelplus.ef.com.cn/sp/img/itinerary/grand-tour-of-italy/2.jpg" />
							</div>
							<div class="bgIntro">
								<div class="transparentBg"></div>
								<div class="transparentTxt">梵蒂冈不可思议的建筑</div>
					...
					<div class="swiper-slide">
						<div class="swiperBgWrap">
							<div class="slideBg">
								<img src="http://travelplus.ef.com.cn/sp/img/itinerary/grand-tour-of-italy/3.jpg" />
							</div>
							<div class="bgIntro">
								<div class="transparentBg"></div>
								<div class="transparentTxt">梵蒂冈不可思议的建筑</div>
					...
					<div class="swiper-slide">
						<div class="swiperBgWrap">
							<div class="slideBg">
								<img src="http://travelplus.ef.com.cn/sp/img/itinerary/grand-tour-of-italy/4.jpg" />
							</div>
							<div class="bgIntro">
								<div class="transparentBg"></div>
								<div class="transparentTxt">梵蒂冈不可思议的建筑</div>
		...
		<div class="site">
			...
			<div class="itineraryIntro section">
				...
				<div class="itineraryMap">
					<img src="http://travelplus.ef.com.cn/sp/img/itinerary/map/grand-tour-of-italy.jpg"  />
				</div>
					<div class="initialScreen">							
						<div class="com_itinerary_summary">
							...
							<div class="itinerary_daily_item">
								<div class="itinerary_daily_title">
									<div class="itemCircle"></div>
									<label>第2天</label><span>科莫观光游</span>
								</div>
								<div class="itinerary_daily_detail">
									<ul>
										<li>在科莫欣赏湖畔景色</li>
							...
							<div class="itinerary_daily_item">						
								<div class="itinerary_daily_title">
									<div class="itemCircle"></div>
									<label>第3天</label><span>前往威尼斯，途中在维罗那稍作停留</span> 
								</div>
								<div class="itinerary_daily_detail">
									<ul>
										<li>途经维罗那竞技场、茱丽叶故居、百草广场和宁柏迪塔</li>
									</ul>
								</div>
							</div>
							<div class="itinerary_daily_item">
								<div class="itinerary_daily_title">
									<div class="itemCircle"></div>
									<label>第4天</label><span>威尼斯观光游</span> 
								</div>
								<div class="itinerary_daily_detail">
									<ul>
							...
							<div class="itinerary_daily_item">						
								<div class="itinerary_daily_title">
									<div class="itemCircle"></div>
									<label>第5天</label><span>前往佛罗伦萨，在费拉拉稍作停留</span> 
								</div>
							</div>
							<div class="itinerary_daily_item">
								<div class="itinerary_daily_title">
									<div class="itemCircle"></div>
									<label>第6天</label><span>佛罗伦萨观光游</span> 
								</div>
								<div class="itinerary_daily_detail">
									<ul>
										<li>参观传奇的佛罗伦萨大教堂</li>
							...
							<div class="itinerary_daily_item">						
								<div class="itinerary_daily_title">
									<div class="itemCircle"></div>
									<label>第7天</label><span>佛罗伦萨自由行</span> 
								</div>
							</div>
							<div class="itinerary_daily_item">
								<div class="itinerary_daily_title">
									<div class="itemCircle"></div>
									<label>第8天</label><span>阿西西观光游</span> 
								</div>
								<div class="itinerary_daily_detail">										
									<ul>
										<li>乘车穿越翁布里亚，前往山腰上的阿西西</li>
										<li>参观阿西西错落的教堂</li>
										<li>参观乔托的艺术作品</li>
									</ul>
								</div>
							...
							<div class="itinerary_daily_item">
								<div class="itinerary_daily_title">
									<div class="itemCircle"></div>
									<label>第9天</label><span>阿西西自由行</span>
								</div>
							</div>
							<div class="itinerary_daily_item">
								<div class="itinerary_daily_title">
									<div class="itemCircle"></div>
									<label>第10天</label><span>经由庞贝前往索伦托</span>
								</div>
								<div class="itinerary_daily_detail">
									<ul>
										<li>游览庞贝古遗址</li>
										<li>参观剧院、别墅、庙宇和浴场遗址</li>
										<li>了解维苏威火山的爆发</li>
									</ul>
								</div>
							</div>
							<div class="itinerary_daily_item">
								<div class="itinerary_daily_title">
									<div class="itemCircle"></div>
									<label>第11天</label><span>索伦托自由行</span>
								</div>
							</div>
							<div class="itinerary_daily_item">
								<div class="itinerary_daily_title">
									<div class="itemCircle"></div>
									<label>第12天</label><span>罗马观光游</span>
								</div>
								<div class="itinerary_daily_detail">
									<ul>
										<li>途经图拉真圆柱和威尼斯广场</li>
							...
							<div class="itinerary_daily_item">
								<div class="itinerary_daily_title">
									<div class="itemCircle"></div>
									<label>第13天</label><span>罗马自由行</span>
								</div>
							</div>
							<div class="itinerary_daily_item">
								<div class="itinerary_daily_title">
									<div class="itemCircle"></div>
									<label>第14天</label><span>返程</span>
								</div>
								<div class="itinerary_daily_detail">
									<ul>
										<li>前往机场搭乘返程航班</li>
						...
						<div class="autoWrapper">
							<div class="com_flightInfo">
								...
								<div class="flex-row-start-between">
									...
									<div class="airport"><span>赫尔辛基</span>16:05</div>
									<div class="airport"><span>米兰</span>18:05</div>
								</div>
							</div>
							<div class="com_flightInfo">
						...
						<div class="autoWrapper">
							<div class="com_flightInfo">
								...
								<div class="flex-row-start-between">
									...
									<div class="airport"><span>北京</span>01:30</div>
									<div class="airport"><span>米兰</span>06:30</div>
								</div>
							</div>
							<div class="com_flightInfo">
								<div class="voyage">回程</div>
