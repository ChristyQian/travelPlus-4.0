...
<html>
	<?php 
	$pageName="itinerary-london-edinburgh-dublin";
	...
	$itineraryName="恋恋翡翠岛，“英爱”而行";
	$itineraryPrice="￥23,200起";
...
?>
	...
	<body data-spy="scroll" data-target="#travelPlusNav">
		...
		<!-- Image -->
		<div class="imagesWrap" style="background:url(img/itinerary/billboard/London-Edinburgh-Dublin.jpg)  center center no-repeat;
			...
			<div class="site">
				<div class="tourInfo">
					...
					<div class="transparentTxt">
						...
						<div class="tourName">恋恋翡翠岛，“英爱”而行</div>
			...
			<div class="itineraryInfo">
				...
				<div class="flex-row-start-around itineraryHighLights">
					...
					<div class="flex1 hightLight">
						<h4>行程亮点</h4>
						<p>
							伦敦著名博物馆<br/> 爱丁堡的城堡、峭壁和迷人街道
							<br/> 爱尔兰人无与伦比的风趣幽默
							<br/> 尽情沉浸在异国文化之中
							<br/> 当地导游带您领略保存完好的隐秘景点
							<br/>
						</p>
					</div>
				</div>
				...
				<div class="initialScreen">
					<div class="com_itinerary_summary">
						...
						<div class="itinerary_daily_item">
							<div class="itinerary_daily_title">
								<div class="itemCircle"></div>
								<label>第4天</label><span>前往爱丁堡</span>
							</div>
							<div class="itinerary_daily_detail">
								<ul>
									<li>搭乘火车一览英格兰田园风光以及苏格兰的湖泊和丘陵，随后抵达苏格兰首府。</li>
								</ul>
							</div>
						</div>
						<div class="itinerary_daily_item">
							<div class="itinerary_daily_title">
								<div class="itemCircle"></div>
								<label>第5天</label><span>爱丁堡观光游</span>
							</div>
							<div class="itinerary_daily_detail">
								<ul>
									<li>参观典雅的格鲁吉亚新城和皇家一英里</li>
									<li>途经沃尔特·司各特纪念碑</li>
									<li>进入爱丁堡城堡，欣赏苏格兰御宝和斯昆石</li>
									<li>下午自由活动</li>
								</ul>
							</div>
						</div>
						<div class="itinerary_daily_item">
							<div class="itinerary_daily_title">
								<div class="itemCircle"></div>
								<label>第6天</label><span>前往都柏林</span>
							</div>
							<div class="itinerary_daily_detail">
								<ul>
									<li>上午前往都柏林，晚上自由活动</li>
								</ul>
							</div>
						</div>
						<div class="itinerary_daily_item">
							<div class="itinerary_daily_title">
								<div class="itemCircle"></div>
								<label>第7天</label><span>都柏林观光游</span>
							</div>
							<div class="itinerary_daily_detail">
								<ul>
									<li>途经圣斯蒂芬绿地，欣赏梅瑞恩广场上的格鲁吉亚风格建筑</li>
									<li>漫步格拉夫顿街，参观莫利·马隆雕像和圣三一学院</li>
									<li>步入圣帕特里克大教堂</li>
									<li>下午在都柏林自由活动，晚上参加告别晚宴</li>
								</ul>
							</div>
						</div>
						<div class="itinerary_daily_item">
					...
					<div class="swiper-slide">
						...
						<div class="com_flightInfo">
							...
							<div class="ibWrap">
								...
								<div class="flex1">16h30m</div>
								<div class="flex1">1次中转</div>
							</div>
							<div class="flex-row-start-between">
								<div class="airport"><span>都柏林</span>19:10</div>
								<div class="airport"><span>阿布扎比</span>05:55+1</div>
					...
					<div class="swiper-slide">
						...
						<div class="autoWrapper">
							...
							<div class="com_flightInfo">
								...
								<div class="flex-row-start-between">
									<div class="airport"><span>都柏林</span>13:15</div>
						...
						<div class="autoWrapper">
							<div class="com_flightInfo">
								...
								<div class="flex-row-start-between">
									...
									<div class="airport"><span>伦敦</span>15:30</div>
								</div>
							</div>
							<div class="com_flightInfo">
								<div class="voyage">回程</div>
								...
								<div class="flex-row-start-between">
									<div class="airport"><span>都柏林</span>12:50</div>
									<div class="airport"><span>伦敦</span>14:25</div>
									<div class="airport"><span>伦敦</span>16:20</div>
