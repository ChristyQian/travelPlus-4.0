...
<html>
	<head>
		...
		<style>
			.imagesWrap {
				background:url(img/itinerary/billboard/Highlights-of-Northern-Europe--London-to-Copenhagen.jpg)  center center no-repeat;
				...
				<div class="swiper-wrapper">
					<div class="swiper-slide">
						<div class="swiperBgWrap">
							<div class="slideBg">
								<img src="http://travelplus.ef.com.cn/sp/img/itinerary/highlights-of-northern-europe-london-to-copenhagen/1.jpg" />
							</div>
							<div class="bgIntro">
								<div class="transparentBg"></div>
					...
					<div class="swiper-slide">
						<div class="swiperBgWrap">
							<div class="slideBg">
								<img src="http://travelplus.ef.com.cn/sp/img/itinerary/highlights-of-northern-europe-london-to-copenhagen/2.jpg" />
							</div>
							<div class="bgIntro">
								<div class="transparentBg"></div>
								<div class="transparentTxt">梵蒂冈不可思议的建筑</div>
					...
					<div class="swiper-slide">
						<div class="swiperBgWrap">
							<div class="slideBg">
								<img src="http://travelplus.ef.com.cn/sp/img/itinerary/highlights-of-northern-europe-london-to-copenhagen/3.jpg" />
							</div>
							<div class="bgIntro">
								<div class="transparentBg"></div>
								<div class="transparentTxt">梵蒂冈不可思议的建筑</div>
					...
					<div class="swiper-slide">
						<div class="swiperBgWrap">
							<div class="slideBg">
								<img src="http://travelplus.ef.com.cn/sp/img/itinerary/highlights-of-northern-europe-london-to-copenhagen/4.jpg" />
							</div>
							<div class="bgIntro">
								<div class="transparentBg"></div>
								<div class="transparentTxt">梵蒂冈不可思议的建筑</div>
		...
		<div class="site">
			...
			<div class="itineraryIntro section">
				...
				<div class="itineraryMap">
					<img src="http://travelplus.ef.com.cn/sp/img/itinerary/map/highlights-of-northern-europe-london-to-copenhagen.jpg"  />
				</div>
				<div class="initialScreen">							
					<div class="com_itinerary_summary">
						...
						<div class="itinerary_daily_item">
							...
							<div class="itinerary_daily_detail">
								<ul>
									<li>穿过特拉法加广场和位于卢德门山上的巴洛克式圣保罗大教堂</li>
									<li>参观威斯敏斯特教堂</li>
									<li>参观大本钟、伦敦眼和伦敦塔等标志性建筑</li>
									<li>驻足白金汉宫</li>
									<li>在欢迎晚宴上与同行伙伴见面</li>
								</ul>
							</div>
						...
						<div class="itinerary_daily_item">
							...
							<div class="itinerary_daily_detail">
								<ul>
									<li>漫步运河与大桥，欣赏点缀于河岸的船屋</li>
									<li>参观水坝广场、新古典主义皇家宫殿、15世纪的新教堂和国家纪念碑</li>
									<li>经过安妮·弗兰克之家</li>
									<li>步入梵高博物馆一饱眼福</li>
									<li>晚上在阿姆斯特丹自由活动</li>
								</ul>
						...
						<div class="itinerary_daily_item">
							<div class="itinerary_daily_title">
								<div class="itemCircle"></div>
								<label>第9天</label><span>前往哥本哈根</span>
							</div>
						</div>
						<div class="itinerary_daily_item">
							<div class="itinerary_daily_title">
								<div class="itemCircle"></div>
								<label>第10天</label><span>哥本哈根观光游</span>
							</div>
							<div class="itinerary_daily_detail">
								<ul>
									<li>参观克里斯蒂安堡宫</li>
									<li>参观罗森堡城堡</li>
									<li>参观新港区的码头区房屋和商店</li>
									<li>参观小美人鱼雕像</li>
									<li>乘船游览哥本哈根运河</li>
									<li>与同行伙伴共享欢送晚宴</li>
								</ul>
			...
			<div class="swiper-container">
				<div class="swiper-wrapper">
					...
					<div class="swiper-slide">
						<div class="swiperBgWrap">
							<div class="slideBg">
								<img src="img/hotel/Nh Hamburg Altona/Nh Hamburg Altona_dining.jpg" />
							</div>
							<div class="hotelIntro">
								<div class="transparentBg"></div>
					...
					<div class="swiper-slide">
						<div class="swiperBgWrap">
							<div class="slideBg">
								<img src="img/hotel/Nh Hamburg Altona/Nh Hamburg Altona_room.jpg" />
							</div>
							<div class="hotelIntro">
								<div class="transparentBg"></div>
								<div class="transparentTxt">Nh Hamburg Altona汉堡阿尔托那NH酒店</div>
						...
						<div class="autoWrapper">
							<div class="com_flightInfo">
								...
								<div class="flex-row-start-between">
									...
									<div class="airport"><span>赫尔辛基</span>16:00</div>
									<div class="airport"><span>伦敦</span>17:10</div>
								</div>
							</div>
							<div class="com_flightInfo">
					...
					<div class="swiper-slide">
						<div class="com_flightInfo">
							...
							<div class="flex-row-start-between">
								...
								<div class="airport"><span>巴黎</span>07:30</div>
								<div class="airport"><span>伦敦</span>07:50</div>
							</div>
						</div>
						<div class="com_flightInfo">
							<div class="voyage">回程</div>
