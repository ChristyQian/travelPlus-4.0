...
<html>
	<?php 
	$pageName="itinerary-venice-florence-rome";
	...
	$itineraryName="意大利文艺复兴之旅";
	$itineraryPrice="￥18,500起";
			...
			<div class="itineraryInfo">
				...
				<div class="flex-row-start-around itineraryHighLights">
					...
					<div class="flex1 hightLight">
						<h4>行程亮点</h4>
						<p>
							漫步感受威尼斯的灵与魂<br/> 发现佛罗伦萨的艺术与大师名作
							<br/> 在罗马追寻凯撒大帝的足迹
							<br/> 葡萄酒、意大利面和披萨，品味食物中的美学
							<br/> 投入宁静的乡村，远离城市喧嚣
							<br/> 还原梦寐以求的意大利经典
							<br/>
						</p>
		...
		<div class="site">
			...
			<div class="itineraryIntro section">
				...
				<div class="itineraryMap">
					<img src="img/itinerary/map/venice-florence-rome.jpg" />
				</div>
