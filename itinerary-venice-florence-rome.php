...
<html>
	<head>
		...
		<style>
			.imagesWrap {
				background:url(img/itinerary/billboard/Venice-Florence-Rome.jpg) center center no-repeat;
				...
				<div class="swiper-wrapper">
					<div class="swiper-slide">
						<div class="swiperBgWrap">
							<div class="slideBg">
								<img src="http://travelplus.ef.com.cn/sp/img/itinerary/venice-florence-rome/1.jpg" />
							</div>
							<div class="bgIntro">
								<div class="transparentBg"></div>
					...
					<div class="swiper-slide">
						<div class="swiperBgWrap">
							<div class="slideBg">
								<img src="http://travelplus.ef.com.cn/sp/img/itinerary/venice-florence-rome/2.jpg" />
							</div>
							<div class="bgIntro">
								<div class="transparentBg"></div>
								<div class="transparentTxt">梵蒂冈不可思议的建筑</div>
					...
					<div class="swiper-slide">
						<div class="swiperBgWrap">
							<div class="slideBg">
								<img src="http://travelplus.ef.com.cn/sp/img/itinerary/venice-florence-rome/3.jpg" />
							</div>
							<div class="bgIntro">
								<div class="transparentBg"></div>
								<div class="transparentTxt">梵蒂冈不可思议的建筑</div>
					...
					<div class="swiper-slide">
						<div class="swiperBgWrap">
							<div class="slideBg">
								<img src="http://travelplus.ef.com.cn/sp/img/itinerary/venice-florence-rome/4.jpg" />
							</div>
							<div class="bgIntro">
								<div class="transparentBg"></div>
								<div class="transparentTxt">梵蒂冈不可思议的建筑</div>
		...
		<div class="site">
			...
			<div class="itineraryIntro section">
				...
				<div class="itineraryMap">
					<img src="http://travelplus.ef.com.cn/sp/img/itinerary/map/venice-florence-rome.jpg"  />
				</div>
				<div class="initialScreen">							
					<div class="com_itinerary_summary">
						...
						<div class="itinerary_daily_item">
							<div class="itinerary_daily_title">
								<div class="itemCircle"></div>
								<label>第2天</label><span>威尼斯观光游</span>
							</div>
							<div class="itinerary_daily_detail">
								<ul>
									<li>进入标志性的圣马克广场和圣马克教堂参观</li>
									<li>参观庄严的哥特式建筑总督宫</li>
									<li>参观叹息桥</li>
									<li>观赏吹制玻璃演示，了解市内的特色艺术</li>
									<li>在欢迎晚宴上与同行伙伴见面</li>
								</ul>
							</div>
						</div>
						<div class="itinerary_daily_item">						
							<div class="itinerary_daily_title">
								<div class="itemCircle"></div>
								<label>第3天</label><span>威尼斯自由行</span> 
							</div>
						</div>
						<div class="itinerary_daily_item">
							<div class="itinerary_daily_title">
								<div class="itemCircle"></div>
								<label>第4天</label><span>前往佛罗伦萨，开始一天观光游</span> 
							</div>
							<div class="itinerary_daily_detail">
								<ul>
									<li>参观传奇的佛罗伦萨大教堂</li>
									...
									<li>沿阿诺河漫步，穿越乌菲兹美术馆的院落，前往佛罗伦萨市中心领主广场</li>
								</ul>
							</div>
						</div>
						<div class="itinerary_daily_item">						
							<div class="itinerary_daily_title">
								<div class="itemCircle"></div>
								<label>第5天</label><span>佛罗伦萨自由行</span> 
							</div>
						</div>
						<div class="itinerary_daily_item">
							<div class="itinerary_daily_title">
								<div class="itemCircle"></div>
								<label>第6天</label><span>佛罗伦萨自由行</span> 
							</div>
						</div>
						<div class="itinerary_daily_item">						
							<div class="itinerary_daily_title">
								<div class="itemCircle"></div>
								<label>第7天</label><span>取道奥维多前往罗马</span> 
							</div>
							<div class="itinerary_daily_detail">
								<ul>
									<li>乘坐缆车攀上奥维多</li>
						...
						<div class="itinerary_daily_item">
							<div class="itinerary_daily_title">
								<div class="itemCircle"></div>
								<label>第8天</label><span>罗马观光游</span> 
							</div>
							<div class="itinerary_daily_detail">
								<ul>
						...
						<div class="itinerary_daily_item">
							<div class="itinerary_daily_title">
								<div class="itemCircle"></div>
								<label>第9天</label><span>罗马自由行</span>
							</div>
						</div>
						<div class="itinerary_daily_item">
							<div class="itinerary_daily_title">
								<div class="itemCircle"></div>
								<label>第10天</label><span>罗马自由行</span>
							</div>
						</div>
						<div class="itinerary_daily_item">
							<div class="itinerary_daily_title">
			...
			<div class="swiper-container">
				<div class="swiper-wrapper">
					<div class="swiper-slide">
						<div class="swiperBgWrap">
							<div class="slideBg">
								<img src="img/hotel/Hotel Giorgione/Hotel Giorgione_dining.jpg" />
							</div>
							<div class="hotelIntro">
								<div class="transparentBg"></div>
								<div class="transparentTxt">Hotel Giorgione乔尔乔涅酒店</div>
							</div>
						</div>
						<div class="hotelDes">乔尔乔涅酒店位于威尼斯最地道最真实的位置，坐落在一个安静的区域，远离喧嚣的游客，距离里亚托桥（Rialto Bridge）和圣马可广场（St. Mark's Square）以及该市最著名的景点仅有几分钟的路程。</div>
					</div>
					<div class="swiper-slide">
						<div class="swiperBgWrap">
							<div class="slideBg">
								<img src="img/hotel/Hotel Giorgione/Hotel Giorgione_room.jpg" />
							</div>
							<div class="hotelIntro">
								<div class="transparentBg"></div>
								<div class="transparentTxt">Hotel Giorgione乔尔乔涅酒店</div>
						...
						<div class="hotelDes">酒店附近景点有：圣马可广场、里亚托桥、玻璃工厂。</div>
					</div>
					<div class="swiper-slide">
						<div class="swiperBgWrap">
							<div class="slideBg">
								<img src="img/hotel/Hotel Giorgione/Hotel Giorgione_swimming pool.jpg" />
							</div>
							<div class="hotelIntro">
								<div class="transparentBg"></div>
								<div class="transparentTxt">Hotel Giorgione乔尔乔涅酒店</div>
					...
					<div class="swiper-slide">
						...
						<div class="hotelDes">从酒店步行10分钟可以到达：佛罗伦萨大教堂和乔托钟楼、佛罗伦萨学院美术馆（大卫像）、世界上最古老的药妆店之一“圣塔玛利亚诺维拉”、巴杰罗美术馆。</div>
					</div>
					<div class="swiper-slide">
						<div class="swiperBgWrap">
							<div class="slideBg">
						...
						<div class="autoWrapper">
							<div class="com_flightInfo">
								...
								<div class="flex-row-start-between">
									...
									<div class="airport"><span>威尼斯</span>19:40</div>
								</div>
							</div>
							<div class="com_flightInfo">
								...
								<div class="flex-row-start-between">
									<div class="airport"><span>罗马</span>10:15</div>
						...
						<div class="autoWrapper">
							<div class="com_flightInfo">
								...
								<div class="flex-row-start-between">
									...
									<div class="airport"><span>巴黎</span>14:00</div>
									<div class="airport"><span>巴黎</span>15:40</div>
									<div class="airport"><span>威尼斯</span>17:15</div>
								</div>
							</div>
							<div class="com_flightInfo">
								<div class="voyage">回程</div>
					...
					<div class="swiper-slide">
						<div class="com_flightInfo">
							...
							<div class="flex-row-start-between">
								...
								<div class="airport"><span>巴黎</span>06:50</div>
								<div class="airport"><span>巴黎</span>10:25</div>
								<div class="airport"><span>威尼斯</span>12:00</div>
							</div>
						</div>
						<div class="com_flightInfo">
							<div class="voyage">回程</div>
							<div class="ibWrap">
								...
								<div class="flex1">13h45m</div>
								<div class="flex1">直飞</div>
							</div>
							<div class="flex-row-start-between">
								<div class="airport"><span>罗马</span>14:00</div>
								<div class="airport"><span>广州</span>09:45+1</div>								
							</div>
						</div>
					</div>
					<div class="swiper-slide">
						<div class="com_flightInfo">
							...
							<div class="flex-row-start-between">
								...
								<div class="airport"><span>威尼斯</span>22:15</div>
							</div>
						</div>
						<div class="com_flightInfo">
							<div class="voyage">回程</div>
							<div class="ibWrap">
								...
								<div class="flex1">17h55m</div>
								<div class="flex1">1次中转</div>
							</div>
							<div class="flex-row-start-between">
								<div class="airport"><span>罗马</span>12:55</div>
								<div class="airport"><span>阿姆斯特丹</span>15:25</div>
