...
<html>
	<?php 
	$pageName="itinerary-grand-tour-of-spain";
	...
	$itineraryName="西班牙全景深度游";
	$itineraryPrice="￥21,800起";
			...
			<div class="itineraryInfo">
				...
				<div class="flex-row-start-around itineraryHighLights">
					...
					<div class="flex1 hightLight">
						<h4>行程亮点</h4>
						<p>
							品尝美味塔帕斯和桑格利亚汽酒<br/> 体验马德里和巴塞罗那夜生活
							<br/> 体验安达卢西亚的融合文化
							<br/> 参观高迪作品
							<br/> 体验弗拉明戈文化
							<br/>
			...
			<div class="swiper-container">
				<div class="swiper-wrapper">
					...
					<div class="swiper-slide">
						<div class="swiperBgWrap">
							<div class="slideBg">
								<img src="img/itinerary/grand-tour-of-spain-2.jpg" />
							</div>
							<div class="bgIntro">
								<div class="transparentBg"></div>
								<div class="transparentTxt">梵蒂冈不可思议的建筑</div>
				...
				<div class="initialScreen">
					<div class="com_itinerary_summary">
						...
						<div class="itinerary_daily_item">
							<div class="itinerary_daily_title">
								<div class="itemCircle"></div>
								<label>第2天</label><span>马德里观光游</span>
							</div>
							<div class="itinerary_daily_detail">
								<ul>
									<li>驻足西班牙皇家宫殿</li>
						...
						<div class="itinerary_daily_item">
							<div class="itinerary_daily_title">
								<div class="itemCircle"></div>
								<label>第3天</label><span>马德里自由行</span>
							</div>
						</div>
						<div class="itinerary_daily_item">
							<div class="itinerary_daily_title">
								<div class="itemCircle"></div>
								<label>第4天</label><span>途径科尔多瓦，前往塞维利亚</span>
							</div>
							<div class="itinerary_daily_detail">
								<ul>
									<li>途中在科尔多瓦景点停留，参观橄榄油种植农场，品尝西班牙橄榄油</li>
								</ul>
							</div>
						</div>
						<div class="itinerary_daily_item">
							<div class="itinerary_daily_title">
								<div class="itemCircle"></div>
								<label>第5天</label><span>塞维利亚观光游</span>
							</div>
							<div class="itinerary_daily_detail">
								<ul>
									<li>游览塞维利亚西班牙广场</li>
						...
						<div class="itinerary_daily_item">
							<div class="itinerary_daily_title">
								<div class="itemCircle"></div>
								<label>第6天</label><span>取道龙达小镇前往西班牙阳光海岸</span>
							</div>
							<div class="itinerary_daily_detail">
								<ul>
									<li>参观“悬崖边的白色小镇”龙达小镇，包括龙达新桥、斗牛场等景点</li>
									<li>欣赏到一望无际的海景</li>
								</ul>
							</div>
						</div>
						...
						<div class="itinerary_daily_item">
							<div class="itinerary_daily_title">
								<div class="itemCircle"></div>
								<label>第8天</label><span>格拉纳达观光游</span>
							</div>
							<div class="itinerary_daily_detail">
								<ul>
									<li>探索阿尔罕布拉宫</li>
									<li>瞻仰西方艺术和伊斯兰设计的完美结合</li>
									<li>漫步装饰华丽的院落</li>
								</ul>
							</div>
						</div>
						...
						<div class="itinerary_daily_item">
							<div class="itinerary_daily_title">
								<div class="itemCircle"></div>
								<label>第10天</label><span>瓦伦西亚观光游</span>
							</div>
							<div class="itinerary_daily_detail">
								<ul>
									<li>进入法亚博物馆参观</li>
						...
						<div class="itinerary_daily_item">
							<div class="itinerary_daily_title">
								<div class="itemCircle"></div>
								<label>第11天</label><span>途经海滨堡垒潘尼斯科拉，前往巴塞罗那</span>
							</div>
						</div>
						<div class="itinerary_daily_item">
							<div class="itinerary_daily_title">
								<div class="itemCircle"></div>
								<label>第12天</label><span>巴塞罗那观光游</span>
							</div>
							<div class="itinerary_daily_detail">
								<ul>
			...
			<div class="swiper-container">
				<div class="swiper-wrapper">
					<div class="swiper-slide">
						<div class="swiperBgWrap">
							<div class="slideBg">
								<img src="img/hotel/Abba Granada/Abba Granada_dining.jpg" />
							</div>
							<div class="hotelIntro">
								<div class="transparentBg"></div>
								<div class="transparentTxt">Abba Granada格拉纳达阿巴酒店</div>
							</div>
						</div>
						<div class="hotelDes">格拉纳达阿巴酒店是一家迷人的4星级酒店，拥有136间漂亮的客房，位于格拉纳达市中心，就近胜利花园和阿尔拜辛区。</div>
					</div>
					<div class="swiper-slide">
						<div class="swiperBgWrap">
							<div class="slideBg">
								<img src="img/hotel/Abba Granada/Abba Granada_gym.jpg" />
							</div>
							<div class="hotelIntro">
								<div class="transparentBg"></div>
								<div class="transparentTxt">Abba Granada格拉纳达阿巴酒店</div>
						...
						<div class="hotelDes">距离格拉纳达大教堂1300米、距离胜利花园 50米、距离阿尔拜辛区 1500米。</div>
					</div>
					<div class="swiper-slide">
						<div class="swiperBgWrap">
							<div class="slideBg">
								<img src="img/hotel/Abba Granada/Abba Granada_room.jpg" />
							</div>
							<div class="hotelIntro">
								<div class="transparentBg"></div>
								<div class="transparentTxt">Abba Granada格拉纳达阿巴酒店</div>
					...
					<div class="swiper-slide">
						<div class="swiperBgWrap">
							<div class="slideBg">
								<img src="img/hotel/Abba Granada/Abba Granada_swimming pool.jpg" />
							</div>
							<div class="hotelIntro">
								<div class="transparentBg"></div>
								<div class="transparentTxt">Abba Granada格拉纳达阿巴酒店</div>
					...
					<div class="swiper-slide">
						...
						<div class="com_flightInfo">
							...
							<div class="flex-row-start-between">
								...
								<div class="airport"><span>北京</span>23:15</div>
								<div class="airport"><span>北京</span>01:25</div>
								<div class="airport"><span>马德里</span>06:55</div>
							</div>
						</div>
						<div class="com_flightInfo">
							...
							<div class="ibWrap">
								...
								<div class="flex1">18h35m</div>
								<div class="flex1">1次中转</div>
							</div>
							<div class="flex-row-start-between">
								<div class="airport"><span>巴塞罗那</span>11:25</div>
								<div class="airport"><span>北京</span>06:25+1</div>
								<div class="airport"><span>北京</span>09:00</div>
								<div class="airport"><span>成都</span>12:00</div>
							</div>
						</div>
					</div>
					<div class="swiper-slide">
					...
					<div class="swiper-slide">
						...
						<div class="autoWrapper">
							<div class="com_flightInfo">
								...
								<div class="flex-row-start-between">
									<div class="airport"><span>北京</span>11:15</div>
									<div class="airport"><span>伦敦</span>15:20</div>
									<div class="airport"><span>伦敦</span>16:40</div>
									<div class="airport"><span>马德里</span>20:10</div>
								</div>
							</div>
							<div class="com_flightInfo">
								<div class="voyage">回程</div>
								...
								<div class="flex-row-start-between">
									...
									<div class="airport"><span>伦敦</span>14:30</div>
					...
					<div class="swiper-slide">
						...
						<div class="com_flightInfo">
							...
							<div class="flex-row-start-between">
								...
								<div class="airport"><span>阿姆斯特丹</span>09:30</div>
								<div class="airport"><span>马德里</span>12:05</div>
							</div>
						</div>
						<div class="com_flightInfo">
							<div class="voyage">回程</div>
							<div class="ibWrap">
								...
								<div class="flex1">18h30m</div>
								<div class="flex1">1次中转</div>
							</div>
							<div class="flex-row-start-between">
								<div class="airport"><span>巴塞罗那</span>06:20</div>
								<div class="airport"><span>阿姆斯特丹</span>08:45</div>
								<div class="airport"><span>阿姆斯特丹</span>13:35</div>
								<div class="airport"><span>广州</span>06:50+1</div>
							</div>
						</div>
					</div>
					<div class="swiper-slide">
						...
						<div class="com_flightInfo">
							...
							<div class="flex-row-start-between">
								...
								<div class="airport"><span>阿姆斯特丹</span>20:50</div>
								<div class="airport"><span>马德里</span>23:25</div>
							</div>
						</div>
						<div class="com_flightInfo">
							<div class="voyage">回程</div>
							<div class="ibWrap">
								<div class="flex1">法国航空</div>
								<div class="flex1">16h10m</div>
								<div class="flex1">1次中转</div>
							</div>
							<div class="flex-row-start-between">
								<div class="airport"><span>巴塞罗那</span>19:25</div>
								<div class="airport"><span>巴黎</span>21:20</div>
