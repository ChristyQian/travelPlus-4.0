...
<html>
<?php 
	$pageName="Tours to Switzerland & Europe";
				...
				<div class="relDiv">			
					...
					<div class="site" data-target="#card">
						<div class="browse-banner">
							<div class="browse-banner-bg"><img class="browse-banner-overlay" src="img/itinerary/billboard/swiss.jpg" width="100%"/></div>
									...
									<div class="">
										<div class="landingInfo">
											...
											<div class="transparentTxt">
												<h5>Switzerland Tours</h5>
												<h1>玩在瑞士</h1>
												<p>在瑞士你能欣赏到阿尔卑斯山令人叹为观止的美，在这里还有白雪皑皑的山脉，迷人精致的河畔小镇，富饶油绿的田园，极具历史感的城堡在等着你来发现。
												</p>
											</div>
										</div>		 
