...
?>
	<body data-spy="scroll" data-target="#travelPlusNav" class="laliga">
		...
		<!-- Image -->
		<div class="imagesWrap" style="background:url(img/itinerary/laliga/billboard/w_f1d903bd3d08170810scr_6099.jpg) center center no-repeat;
		...
		<div class="site">			
			<div class="laligaPoints">
				<div>
					...
					<div class="ibWrap relDiv"><img src="img/itinerary/Laliga/ADM-RAM/nine_2852.jpg" width="100%" /><p>共赴万达大都会球场，见证首场同城德比</p></div>
				</div>
				<div>
					<div class="ibWrap textWrap">
						<h6>同城竞技</h6>
				...
				<div class="initialScreen">							
					<div class="com_itinerary_summary">
						...
						<div class="itinerary_daily_item">						
							...
							<div class="itinerary_daily_detail">
								<ul>
									<li>白天在马德里自由活动，晚上在现场见证同城德比，马竞与皇马的球场厮杀。</li>
								</ul>
							</div>
						</div>
						<div class="itinerary_daily_item">
