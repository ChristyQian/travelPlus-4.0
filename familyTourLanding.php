...
?>	
				...
				<div class="relDiv">			
					...
					<div class="site" data-target="#card">
						<div class="browse-banner">
							<div class="browse-banner-bg"><img class="browse-banner-overlay" src="img/itinerary/billboard/familyTour.jpg" width="100%"/></div>
							<div class="site browse-banner-content">
									...
									<div class="">
										<div class="landingInfo">
											...
											<div class="transparentTxt">
												<h5 style="font-size:14px;line-height:initial;">Family Tour</h5>
												<h1>带着宝贝看世界</h1>
												<div>
													<p>宝贝的童心，你的悠闲假期，你们的亲子时光，在这里将一一实现！冰岛、西葡、西法意、德瑞奥等多条亲子主题线路，寓教于乐，给孩子一个不一样的童年！<br/><br/>早鸟优惠限时中，全家出游，每人立减3,000RMB！
													</p>
												</div>
											</div>
										</div>		 
								...
								<div class="rightWrap">
									<h5 class="rightWrapHead">给孩子一个不一样的童年！&nbsp;&gt;&gt;</h5>									
		...
		<div class="site landing">		
			<div class="twoThird section">
				<h4>"亲子团"相关行程<span class="frNote">共4条结果</span></h4>
