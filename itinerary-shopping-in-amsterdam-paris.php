...
?>
	...
	<body data-spy="scroll" data-target="#travelPlusNav">
		...
		<!-- Image -->
		<div class="imagesWrap" style="background:url(img/itinerary/billboard/shopping-in-amsterdam-paris.jpg)  center center no-repeat; background-size:cover;">
			<div class="site">
				<div class="tourInfo">
					<div class="transparentBg"></div>
					<div class="transparentTxt">
						<div class="yellowTxt">新年档</div>
						<div class="tourName">新年打折季购物之旅</div>
			...
			<div class="itineraryInfo">
				...
				<div class="flex-row-start-around itineraryHighLights">
					...
					<div class="flex1 hightLight">
						<h4>行程亮点</h4>
						<p>
							圣诞新年双重折扣，欧洲购物狂欢买到手软，全程无强制购物
							<br/> 巴黎跨年夜告别晚餐，享受异国新年夜的别样狂欢 
							<br/> 梵高美术馆、卢浮宫重点体验，收获大师之作的独具匠心
							<br/> 充足自由时间定制你的浪漫巴黎和阿姆斯特丹，并有当地向导提供最地道的自由行攻略和地点
							<br/> 推荐品味正宗法式大餐，在跨年夜沉醉在巴黎烟火秀中
						</p>
					</div>
				</div>
			</div>
				...
				<div class="initialScreen">
					<div class="com_itinerary_summary">
						...
						<div class="itinerary_daily_item">
							<div class="itinerary_daily_title">
								<div class="itemCircle"></div>
								<label>第6天</label><span>巴黎告别晚宴</span>
							</div>
							<div class="itinerary_daily_detail">
								<ul>
									<li>白天时间内自由活动</li>
									<li>与伙伴们享用一顿法式晚宴，感谢旅途有他们相伴</li>
								</ul>
							</div>
						</div>
						<div class="itinerary_daily_item">
							<div class="itinerary_daily_title">
								<div class="itemCircle"></div>
								<label>第7天</label><span>参观卢浮宫</span>
							</div>
							<div class="itinerary_daily_detail">
								<ul>
									<li>驱车前往卢浮宫参观，你将会见到《断臂维纳斯》、《胜利女神像》和《蒙娜丽莎》</li>
									<li>下午自由活动</li>
								</ul>
							</div>
						</div>
						<div class="itinerary_daily_item">
							<div class="itinerary_daily_title">
								<div class="itemCircle"></div>
								<label>第8天</label><span>前往机场乘坐返程航班</span>
							</div>
						</div>
						<div class="itinerary_daily_item">
							<div class="itinerary_daily_title">
					...
					<div class="swiper-slide">
						...
						<div class="autoWrapper">
							<div class="com_flightInfo">
								...
								<div class="flex-row-start-between">
									<div class="airport"><span>成都</span>19:30</div>
									<div class="airport"><span>北京</span>22:10</div>
									<div class="airport"><span>北京</span>00:30</div>
									<div class="airport"><span>阿姆斯特丹</span>04:40</div>
								</div>
							</div>
							<div class="com_flightInfo">
								...
								<div class="flex-row-start-between">
									<div class="airport"><span>巴黎</span>11:45</div>
									<div class="airport"><span>广州</span>06:20+1</div>
									<div class="airport"><span>广州</span>10:20</div>
									<div class="airport"><span>成都</span>12:50</div>
								</div>
							</div>
						</div>
					</div>
					<div class="swiper-slide">
						...
						<div class="autoWrapper">
							...
							<div class="com_flightInfo">
								...
								<div class="flex-row-start-between">
									<div class="airport"><span>巴黎</span>13:35</div>
									<div class="airport"><span>上海</span>07:50+1</div>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="autoWrapper">
							...
							<div class="com_flightInfo">
								...
								<div class="flex-row-start-between">
									...
									<div class="airport"><span>香港</span>18:35</div>
								</div>
							</div>
						</div>
					</div>
