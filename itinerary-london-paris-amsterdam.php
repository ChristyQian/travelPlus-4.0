...
<?php 
	...
	$itineraryName="邂逅惬意欧洲之旅";
	$itineraryPrice="￥22,500起";
...
?>
	<body data-spy="scroll" data-target="#travelPlusNav">
		...
		<!-- Image -->
		<div class="imagesWrap" style="background:url(img/itinerary/billboard/London-Paris-Amsterdam.jpg)  center center no-repeat;
			...
			<div class="site">
				<div class="tourInfo">
					...
					<div class="transparentTxt">
						...
						<div class="tourName">邂逅惬意欧洲之旅</div>
				...
				<div class="swiper-wrapper">
					<div class="swiper-slide">
						<div class="swiperBgWrap">
							<div class="slideBg">
								<img src="img/itinerary/london-paris-amsterdam-1.jpg" />
							</div>
							<div class="bgIntro">
								<div class="transparentBg"></div>
					...
					<div class="swiper-slide">
						<div class="swiperBgWrap">
							<div class="slideBg">
								<img src="img/itinerary/london-paris-amsterdam-2.jpg" />
							</div>
							<div class="bgIntro">
								<div class="transparentBg"></div>
								<div class="transparentTxt">梵蒂冈不可思议的建筑</div>
					...
					<div class="swiper-slide">
						<div class="swiperBgWrap">
							<div class="slideBg">
								<img src="img/itinerary/london-paris-amsterdam-3.jpg" />
							</div>
							<div class="bgIntro">
								<div class="transparentBg"></div>
								<div class="transparentTxt">梵蒂冈不可思议的建筑</div>
					...
					<div class="swiper-slide">
						<div class="swiperBgWrap">
							<div class="slideBg">
								<img src="img/itinerary/london-paris-amsterdam-5.jpg" />
							</div>
							<div class="bgIntro">
								<div class="transparentBg"></div>
								<div class="transparentTxt">梵蒂冈不可思议的建筑</div>
					...
					<div class="swiper-slide">
						<div class="swiperBgWrap">
							<div class="slideBg">
								<img src="img/itinerary/london-paris-amsterdam-6.jpg" />
							</div>
							<div class="bgIntro">
								<div class="transparentBg"></div>
								<div class="transparentTxt">梵蒂冈不可思议的建筑</div>
				...
				<div class="initialScreen">							
					<div class="com_itinerary_summary">
						...
						<div class="itinerary_daily_item">						
							<div class="itinerary_daily_title">
								<div class="itemCircle"></div>
								<label>第7天</label><span>启程前往阿姆斯特丹</span> 
							</div>
							<div class="itinerary_daily_detail">
								<ul>
									<li>下午在阿姆斯特丹自由活动</li>
						...
						<div class="itinerary_daily_item">
							<div class="itinerary_daily_title">
								<div class="itemCircle"></div>
								<label>第8天</label><span>阿姆斯特丹观光游</span> 
							</div>
							<div class="itinerary_daily_detail">
								<ul>
									<li>漫步运河与大桥，欣赏点缀于河岸的船屋</li>
									<li>参观水坝广场、新古典主义皇家宫殿、 新教堂和国家纪念碑</li>
									<li>经过《安妮日记》作者安妮·弗兰克二战时期的藏身之家</li>
									<li>步入梵高博物馆一饱眼福</li>
									<li>下午在阿姆斯特丹自由活动</li>
								</ul>
							</div>
						...
						<div class="itinerary_daily_item">
							<div class="itinerary_daily_title">
								<div class="itemCircle"></div>
								<label>第9天</label><span>阿姆斯特丹自由行</span>
							</div>
							<div class="itinerary_daily_detail">
								<ul>
									<li>在告别晚餐上和同行伙伴告别</li>
