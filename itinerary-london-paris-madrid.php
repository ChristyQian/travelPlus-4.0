...
<html>
	<?php 
	$pageName="itinerary-london-paris-madrid";
	...
	$itineraryName="欧洲都市文化精品游";
	$itineraryPrice="￥22,000起";
...
?>
	...
	<body data-spy="scroll" data-target="#travelPlusNav">
		...
		<!-- Image -->
		<div class="imagesWrap" style="background:url(img/itinerary/billboard/London-Paris-Madrid.jpg)  center center no-repeat;
			...
			<div class="site">
				<div class="tourInfo">
					...
					<div class="transparentTxt">
						...
						<div class="tourName">欧洲都市文化精品游</div>
			...
			<div class="itineraryInfo">
				...
				<div class="flex-row-start-around itineraryHighLights">
					<div class="flex1 tourGuide">
						<p class="serif">当你来到英国、法国和西班牙的首都，就尽情沉浸于此吧！追寻英国皇室的脚步发现伦敦的亮点，品着香槟游览“光之城”巴黎的城市建筑，在马德里享受悠闲假日。你将发现快节奏的都市，为何个个与众不同。</p>
					...
					<div class="flex1 hightLight">
						<h4>行程亮点</h4>
						<p>
							伦敦的历史性地标<br/> 伦敦众多的著名博物馆
							<br/> 巴黎美丽的林荫大道、街头艺术和城市风情
							<br/> 参观埃菲尔铁塔
							<br/> 参观马德里普拉多博物馆
							<br/> 体验西班牙小吃和精彩夜生活
							<br/>
				...
				<div class="swiper-wrapper">
					<div class="swiper-slide">
						<div class="swiperBgWrap">
							<div class="slideBg">
								<img src="img/itinerary/london-paris-madrid-1.jpg" />
							</div>
							<div class="bgIntro">
								<div class="transparentBg"></div>
					...
					<div class="swiper-slide">
						<div class="swiperBgWrap">
							<div class="slideBg">
								<img src="img/itinerary/london-paris-madrid-2.jpg" />
							</div>
							<div class="bgIntro">
								<div class="transparentBg"></div>
								<div class="transparentTxt">梵蒂冈不可思议的建筑</div>
					...
					<div class="swiper-slide">
						<div class="swiperBgWrap">
							<div class="slideBg">
								<img src="img/itinerary/london-paris-madrid-3.jpg" />
							</div>
							<div class="bgIntro">
								<div class="transparentBg"></div>
								<div class="transparentTxt">梵蒂冈不可思议的建筑</div>
					...
					<div class="swiper-slide">
						<div class="swiperBgWrap">
							<div class="slideBg">
								<img src="img/itinerary/london-paris-madrid-4.jpg" />
							</div>
							<div class="bgIntro">
								<div class="transparentBg"></div>
								<div class="transparentTxt">梵蒂冈不可思议的建筑</div>
					...
					<div class="swiper-slide">
						<div class="swiperBgWrap">
							<div class="slideBg">
								<img src="img/itinerary/london-paris-madrid-5.jpg" />
							</div>
							<div class="bgIntro">
								<div class="transparentBg"></div>
								<div class="transparentTxt">梵蒂冈不可思议的建筑</div>
					...
					<div class="swiper-slide">
						<div class="swiperBgWrap">
							<div class="slideBg">
								<img src="img/itinerary/london-paris-madrid-6.jpg" />
							</div>
							<div class="bgIntro">
								<div class="transparentBg"></div>
								<div class="transparentTxt">梵蒂冈不可思议的建筑</div>
					...
					<div class="swiper-slide">
						<div class="swiperBgWrap">
							<div class="slideBg">
								<img src="img/itinerary/london-paris-madrid-7.jpg" />
							</div>
							<div class="bgIntro">
								<div class="transparentBg"></div>
								<div class="transparentTxt">梵蒂冈不可思议的建筑</div>
		...
		<div class="site">
			...
			<div class="itineraryIntro section">
				...
				<div class="itineraryMap">
					<img src="img/itinerary/map/london-paris-madrid.jpg" />
				</div>
				<div class="initialScreen">
					<div class="com_itinerary_summary">
						...
						<div class="itinerary_daily_item">
							<div class="itinerary_daily_title">
								<div class="itemCircle"></div>
								<label>第2天</label><span>伦敦观光游</span>
							</div>
							<div class="itinerary_daily_detail">
								<ul>
									<li>穿过宏伟的特拉法加广场和位于卢德门山上的巴洛克式圣保罗大教堂</li>
									<li>参观威斯敏斯特教堂</li>
									<li>参观大本钟、伦敦眼、塔桥和伦敦塔等标志性建筑</li>
									<li>驻足白金汉宫</li>
									<li>下午在伦敦自由活动</li>
								</ul>
							</div>
						...
						<div class="itinerary_daily_item">
							<div class="itinerary_daily_title">
								<div class="itemCircle"></div>
								<label>第4天</label><span>途经英吉利海峡前往巴黎</span>
							</div>
							<div class="itinerary_daily_detail">
								<ul>
									<li>搭乘著名的欧洲之星高速列车享受海底之旅</li>
								</ul>
							</div>
						</div>
						<div class="itinerary_daily_item">
							<div class="itinerary_daily_title">
								<div class="itemCircle"></div>
								<label>第5天</label><span>巴黎观光游</span>
							</div>
							<div class="itinerary_daily_detail">
								<ul>
						...
						<div class="itinerary_daily_item">
							<div class="itinerary_daily_title">
								<div class="itemCircle"></div>
								<label>第7天</label><span>飞往马德里</span>
							</div>
						</div>
						<div class="itinerary_daily_item">
							<div class="itinerary_daily_title">
							...
							<div class="itinerary_daily_detail">
								<ul>
									<li>在马德里皇宫拍照留念</li>
									<li>途经马德里古埃及庙宇德波神庙</li>
									<li>参观西班牙广场、马约尔广场和繁华的太阳门</li>
									<li>参观普拉多博物馆</li>
									<li>下午在马德里自由活动</li>
								</ul>
							</div>
						...
						<div class="itinerary_daily_item">
							<div class="itinerary_daily_title">
								<div class="itemCircle"></div>
								<label>第9天</label><span>马德里自由行</span>
							</div>
							<div class="itinerary_daily_detail">
								<ul>
									<li>在告别晚宴上与伙伴告别</li>
				...
				<div class="swiper-wrapper">
					<div class="swiper-slide">
						...
						<div class="com_flightInfo">
							...
							<div class="flex-row-start-between">
								<div class="airport"><span>成都</span>10:00</div>
								<div class="airport"><span>北京</span>12:30</div>
								<div class="airport"><span>北京</span>14:10</div>
								<div class="airport"><span>伦敦</span>17:45</div>
							</div>
						</div>
						<div class="com_flightInfo">
							...
							<div class="ibWrap">
								...
								<div class="flex1">17h20m</div>
								<div class="flex1">1次中转</div>
							</div>
							<div class="flex-row-start-between">
								<div class="airport"><span>马德里</span>11:25</div>
								<div class="airport"><span>北京</span>04:10+1</div>
								<div class="airport"><span>北京</span>07:40</div>
								<div class="airport"><span>成都</span>10:45</div>
							</div>
						</div>
					</div>
					<div class="swiper-slide">
						...
						<div class="autoWrapper">
							<div class="com_flightInfo">
								...
								<div class="flex-row-start-between">
									<div class="airport"><span>上海</span>10:30</div>
									<div class="airport"><span>巴黎</span>16:35</div>
									<div class="airport"><span>巴黎</span>18:15</div>
									<div class="airport"><span>伦敦</span>18:30</div>
								</div>
							</div>
							<div class="com_flightInfo">
								<div class="voyage">回程</div>
								...
								<div class="flex-row-start-between">
									<div class="airport"><span>马德里</span>17:10</div>
					...
					<div class="swiper-slide">
						...
						<div class="autoWrapper">
							...
							<div class="com_flightInfo">
								...
								<div class="flex-row-start-between">
									<div class="airport"><span>马德里</span>10:20</div>
									<div class="airport"><span>赫尔辛基</span>15:30</div>
					...
					<div class="swiper-slide">
						...
						<div class="com_flightInfo">
							...
							<div class="flex-row-start-between">
								...
								<div class="airport"><span>赫尔辛基</span>08:00</div>
								<div class="airport"><span>伦敦</span>09:10</div>
							</div>
						</div>
						<div class="com_flightInfo">
							<div class="voyage">回程</div>
