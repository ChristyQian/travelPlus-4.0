...
?>
	<body data-spy="scroll" data-target="#travelPlusNav">
		...
		<!-- Image -->
		<div class="imagesWrap" style="background:url(img/itinerary/billboard/shopping-in-london-paris-amsterdam.jpg) center center no-repeat;
				background-size:cover;">
			<div class="site">
				<div class="tourInfo">
					<div class="transparentBg"></div>
					<div class="transparentTxt">
						<div class="yellowTxt">Travelzoo专享，最高立减3900</div>						
						<div class="tourName">新年折扣季购物之旅</div>
						<div class="flex-row-start-between">
							...
							<div class="pinkTxt">9月20日前缴付定金有效</div>
						</div>
					</div>
				</div>
				<?php include_once('discount.php'); echo $discount9 ;?>
			</div>
		</div>
		<!-- Itinerary Info -->	  
		<div class="site">
				...
				<div class="swiper-wrapper">
					<div class="swiper-slide">
						<div class="swiperBgWrap">
							<div class="slideBg">
								<img src="img/itinerary/shopping-in-london-paris-amsterdam02.jpg" />
							</div>
							<div class="bgIntro">
								<div class="transparentBg"></div>
					...
					<div class="swiper-slide">
						<div class="swiperBgWrap">
							<div class="slideBg">
								<img src="img/itinerary/shopping-in-london-paris-amsterdam04.jpg" />
							</div>
							<div class="bgIntro">
								<div class="transparentBg"></div>
								<div class="transparentTxt">梵蒂冈不可思议的建筑</div>
					...
					<div class="swiper-slide">
						<div class="swiperBgWrap">
							<div class="slideBg">
								<img src="img/itinerary/shopping-in-london-paris-amsterdam07.jpg" />
							</div>
							<div class="bgIntro">
								<div class="transparentBg"></div>
								<div class="transparentTxt">梵蒂冈不可思议的建筑</div>
		...
		<div class="site">
			...
			<div class="itineraryIntro section">
				...
				<div class="itineraryMap">
					<img src="img/itinerary/map/shopping-in-londan-paris-amsterdam.jpg"  />
				</div>
				<div class="initialScreen">							
					<div class="com_itinerary_summary">
						...
						<div class="itinerary_daily_item">
							<div class="itinerary_daily_title">
								<div class="itemCircle"></div>
								<label>第2天</label><span>阿姆斯特丹观光游及欢迎晚宴</span>
							</div>
							<div class="itinerary_daily_detail">
								<ul>
									<li>在外籍导游的带领下参观阿姆斯特丹市内景点，包括水坝广场、皇家宫殿、新教堂、国家纪念碑、乔安社区、安妮弗兰克故居</li>
						...
						<div class="itinerary_daily_item">						
							<div class="itinerary_daily_title">
								<div class="itemCircle"></div>
								<label>第3天</label><span>阿姆斯特丹自由活动</span> 
							</div>
						</div>
						<div class="itinerary_daily_item">
							<div class="itinerary_daily_title">
								<div class="itemCircle"></div>
								<label>第4天</label><span>前往巴黎</span> 
							</div>
							<div class="itinerary_daily_detail">
								<ul>
									<li>乘坐火车由阿姆斯特丹前往巴黎</li>
									<li>下午时间在巴黎自由活动</li>
								</ul>
							</div>
						</div>
						<div class="itinerary_daily_item">						
							...
							<div class="itinerary_daily_detail">
								<ul>								
									...
									<li>途经巴黎圣母院、埃菲尔铁塔、协和广场等8个著名景点并下车留影</li>
						...
						<div class="itinerary_daily_item">
							<div class="itinerary_daily_title">
								<div class="itemCircle"></div>
								<label>第6天</label><span>巴黎自由活动</span> 
							</div>
						</div>
						<div class="itinerary_daily_item">						
							<div class="itinerary_daily_title">
								<div class="itemCircle"></div>
								<label>第7天</label><span>前往伦敦及伦敦观光游</span> 
							</div>
							<div class="itinerary_daily_detail">
								<ul>
									<li>乘坐欧洲之星列车前往伦敦跨年</li>
									<li>下午驱车前往特拉法尔加广场和圣保罗大教堂</li>
									<li>漫步在泰晤士河畔，观赏伦敦桥、伦敦塔和伦敦眼</li>
									<li>游览伦敦地标哥特式建筑大本钟</li>
									<li>在白金汉宫门前参观一次卫兵换岗仪式</li>
									<li>晚上参加新年特别晚宴，庆贺新的一年的到来</li>
								</ul>
							</div>
						</div>
						<div class="itinerary_daily_item">
							<div class="itinerary_daily_title">
								<div class="itemCircle"></div>
								<label>第8天</label><span>伦敦自由活动</span> 
							</div>
						</div>
						<div class="itinerary_daily_item">
							<div class="itinerary_daily_title">
								<div class="itemCircle"></div>
								<label>第9天</label><span>伦敦告别晚宴</span>
							</div>
							<div class="itinerary_daily_detail">
								<ul>
									<li>白天自由活动，感受新年气息</li>
									<li>晚上参加告别晚宴，结束愉快的旅行</li>
								</ul>
							</div>
						</div>
						<div class="itinerary_daily_item">
			...
			<div class="swiper-container">
				<div class="swiper-wrapper">
					...
					<div class="swiper-slide">
						...
						<div class="hotelDes">自然历史博物馆，维多利亚和阿尔伯特博物馆，科学博物馆和海德公园和肯辛顿花园都在附近。 </div>
					</div>
					<div class="swiper-slide">
						<div class="swiperBgWrap">
							<div class="slideBg">
		...
		<div class="section quoBg" name="getPersonalizedPrice" id="getPersonalizedPrice">
			...
			<div class="quotation">
				...
				<div class="quotationWrap">
					...
					<?php include_once('discount.php') ; echo $discount10 ;?>
