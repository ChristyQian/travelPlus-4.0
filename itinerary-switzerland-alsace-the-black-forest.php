...
<html>
	<?php 
	$pageName="itinerary-switzerland-alsace-the-black-forest";
	...
	$itineraryName="瑞士、阿尔萨斯和黑森林之旅";
	$itineraryPrice="￥26,300";
...
?>
	...
	<body data-spy="scroll" data-target="#travelPlusNav">
		...
		<!-- Image -->
		<div class="imagesWrap" style="background:url(img/itinerary/billboard/Switzerland-Alsace-the-Black-Forest.jpg)  center center no-repeat;
			...
			<div class="site">
				<div class="tourInfo">
					...
					<div class="transparentTxt">
						...
						<div class="tourName">瑞士、阿尔萨斯和黑森林之旅</div>
			...
			<div class="itineraryInfo">
				...
				<div class="flex-row-start-around itineraryHighLights">
					...
					<div class="flex1 hightLight">
						<h4>行程亮点</h4>
						<p>
							卢塞恩和因特拉肯的高山湖泊<br/> 搭乘著名的冰河快车欣赏壮美风光
							<br/> 瑞士标志性高峰——马特峰
							<br/> “欧洲屋脊”少女峰蔚为壮观的美景
							<br/> 中世纪斯特拉斯堡和科尔马的迷人广场与蜿蜒小巷
							<br/> 德国充满传奇色彩的黑森林
							<br/>
						</p>
					</div>
				...
				<div class="swiper-wrapper">
					<div class="swiper-slide">
						<div class="swiperBgWrap">
							<div class="slideBg">
								<img src="img/itinerary/switzerland-alsace-the-black-forest-1.jpg" />
							</div>
							<div class="bgIntro">
								<div class="transparentBg"></div>
					...
					<div class="swiper-slide">
						<div class="swiperBgWrap">
							<div class="slideBg">
								<img src="img/itinerary/switzerland-alsace-the-black-forest-2.jpg" />
							</div>
							<div class="bgIntro">
								<div class="transparentBg"></div>
								<div class="transparentTxt">梵蒂冈不可思议的建筑</div>
					...
					<div class="swiper-slide">
						<div class="swiperBgWrap">
							<div class="slideBg">
								<img src="img/itinerary/switzerland-alsace-the-black-forest-3.jpg" />
							</div>
							<div class="bgIntro">
								<div class="transparentBg"></div>
								<div class="transparentTxt">梵蒂冈不可思议的建筑</div>
					...
					<div class="swiper-slide">
						<div class="swiperBgWrap">
							<div class="slideBg">
								<img src="img/itinerary/switzerland-alsace-the-black-forest-4.jpg" />
							</div>
							<div class="bgIntro">
								<div class="transparentBg"></div>
								<div class="transparentTxt">梵蒂冈不可思议的建筑</div>
					...
					<div class="swiper-slide">
						<div class="swiperBgWrap">
							<div class="slideBg">
								<img src="img/itinerary/switzerland-alsace-the-black-forest-5.jpg" />
							</div>
							<div class="bgIntro">
								<div class="transparentBg"></div>
								<div class="transparentTxt">梵蒂冈不可思议的建筑</div>
					...
					<div class="swiper-slide">
						<div class="swiperBgWrap">
							<div class="slideBg">
								<img src="img/itinerary/switzerland-alsace-the-black-forest-6.jpg" />
							</div>
							<div class="bgIntro">
								<div class="transparentBg"></div>
								<div class="transparentTxt">梵蒂冈不可思议的建筑</div>
					...
					<div class="swiper-slide">
						<div class="swiperBgWrap">
							<div class="slideBg">
								<img src="img/itinerary/switzerland-alsace-the-black-forest-7.jpg" />
							</div>
							<div class="bgIntro">
								<div class="transparentBg"></div>
								<div class="transparentTxt">梵蒂冈不可思议的建筑</div>
				...
				<div class="swiper-wrapper">
						...
						<div class="autoWrapper">
							<div class="com_flightInfo">
								...
								<div class="flex-row-start-between">
									...
									<div class="airport"><span>苏黎世</span>11:20</div>
								</div>
							</div>
							<div class="com_flightInfo">
								<div class="voyage">回程</div>
								...
								<div class="flex-row-start-between">
									<div class="airport"><span>苏黎世</span>13:15</div>
									<div class="airport"><span>北京</span>05:15+1</div>
								</div>
							</div>
						</div>
					</div>
					<div class="swiper-slide">
						...
						<div class="com_flightInfo">
							...
							<div class="flex-row-start-between">
								<div class="airport"><span>香港</span>23:45</div>
								<div class="airport"><span>苏黎世</span>06:10+1</div>
							</div>
						</div>
						<div class="com_flightInfo">
							<div class="voyage">回程</div>
							<div class="ibWrap">
								<div class="flex1">瑞士航空</div>
								<div class="flex1">11h50m</div>
								<div class="flex1">直飞</div>
							</div>
							<div class="flex-row-start-between">
								<div class="airport"><span>苏黎世</span>22:40</div>
