...
<html>
	<?php 
	$pageName="itinerary-rome-sorrento-sicily";
	...
	$itineraryName="意大利南部甜蜜慢生活之旅";
	$itineraryPrice="￥21,000起";
...
?>
	...
	<body data-spy="scroll" data-target="#travelPlusNav">
		...
		<!-- Image -->
		<div class="imagesWrap" style="background:url(img/itinerary/billboard/Sorrento-Rome-Sicily.jpg)  center center no-repeat;
			...
			<div class="site">
				<div class="tourInfo">
					...
					<div class="transparentTxt">
						...
						<div class="tourName">意大利南部甜蜜慢生活之旅</div>
				...
				<div class="swiper-wrapper">
					<div class="swiper-slide">
						<div class="swiperBgWrap">
							<div class="slideBg">
								<img src="img/itinerary/rome-sorrento-sicily-1.jpg" />
							</div>
							<div class="bgIntro">
								<div class="transparentBg"></div>
					...
					<div class="swiper-slide">
						<div class="swiperBgWrap">
							<div class="slideBg">
								<img src="img/itinerary/rome-sorrento-sicily-2.jpg" />
							</div>
							<div class="bgIntro">
								<div class="transparentBg"></div>
								<div class="transparentTxt">梵蒂冈不可思议的建筑</div>
					...
					<div class="swiper-slide">
						<div class="swiperBgWrap">
							<div class="slideBg">
								<img src="img/itinerary/rome-sorrento-sicily-3.jpg" />
							</div>
							<div class="bgIntro">
								<div class="transparentBg"></div>
								<div class="transparentTxt">梵蒂冈不可思议的建筑</div>
					...
					<div class="swiper-slide">
						<div class="swiperBgWrap">
							<div class="slideBg">
								<img src="img/itinerary/rome-sorrento-sicily-4.jpg" />
							</div>
							<div class="bgIntro">
								<div class="transparentBg"></div>
								<div class="transparentTxt">梵蒂冈不可思议的建筑</div>
					...
					<div class="swiper-slide">
						<div class="swiperBgWrap">
							<div class="slideBg">
								<img src="img/itinerary/rome-sorrento-sicily-5.jpg" />
							</div>
							<div class="bgIntro">
								<div class="transparentBg"></div>
								<div class="transparentTxt">梵蒂冈不可思议的建筑</div>
					...
					<div class="swiper-slide">
						<div class="swiperBgWrap">
							<div class="slideBg">
								<img src="img/itinerary/rome-sorrento-sicily-6.jpg" />
							</div>
							<div class="bgIntro">
								<div class="transparentBg"></div>
								<div class="transparentTxt">梵蒂冈不可思议的建筑</div>
		...
		<div class="site">
			...
			<div class="itineraryIntro section">
				...
				<div class="itineraryMap">
					<img src="img/itinerary/map/rome-sorrento-sicily.jpg" />
				</div>
				<div class="initialScreen">
					<div class="com_itinerary_summary">
						...
						<div class="itinerary_daily_item">
							<div class="itinerary_daily_title">
								<div class="itemCircle"></div>
								<label>第2天</label><span>卡普里观光游</span>
							</div>
							<div class="itinerary_daily_detail">
								<ul>
									<li>乘船环岛游，参观卡普里岩洞和石窟</li>
									<li>漫步卡普里村</li>
									<li>乘坐缆车前往卡普里上城</li>
									<li>游览奥古斯花园</li>
									<li>在欢迎晚宴上与同行伙伴见面</li>
						...
						<div class="itinerary_daily_item">
							<div class="itinerary_daily_title">
								<div class="itemCircle"></div>
								<label>第3天</label><span>索伦托自由行</span>
							</div>
						</div>
						<div class="itinerary_daily_item">
							<div class="itinerary_daily_title">
								<div class="itemCircle"></div>
								<label>第4天</label><span>经由庞贝前往罗马</span>
							</div>
							<div class="itinerary_daily_detail">
								<ul>
									<li>游览庞贝古遗址</li>
									<li> 参观罗马的剧院、别墅、庙宇和浴场遗址</li>
									<li> 了解维苏威火山的爆发</li>
									<li> 了解罗马帝国时期的生活</li>
								</ul>
							</div>
						...
						<div class="itinerary_daily_item">
							<div class="itinerary_daily_title">
								<div class="itemCircle"></div>
								<label>第7天</label><span>前往陶尔米纳地区</span>
							</div>
							<div class="itinerary_daily_detail">
								<ul>
									<li>搭乘前往卡塔尼亚的航班，随后前往陶尔米纳地区</li>
									<li>晚上在陶尔米纳自由活动</li>
								</ul>
							</div>
						</div>
						<div class="itinerary_daily_item">
							<div class="itinerary_daily_title">
								<div class="itemCircle"></div>
								<label>第8天</label><span>陶尔米纳观光游</span>
							</div>
							<div class="itinerary_daily_detail">
								<ul>
									<li>游览埃特纳火山、陶尔米纳教堂和科瓦亚宫殿</li>
									<li>进入希腊剧院参观</li>
									<li>晚上和伙伴享用告别晚宴</li>
								</ul>
							</div>
						...
						<div class="itinerary_daily_item">
							<div class="itinerary_daily_title">
								<div class="itemCircle"></div>
								<label>第9天</label><span>陶尔米纳自由行</span>
							</div>
						</div>
						<div class="itinerary_daily_item">
							<div class="itinerary_daily_title">
						...
						<div class="autoWrapper">
							<div class="com_flightInfo">
								...
								<div class="flex-row-start-between">
									...
									<div class="airport"><span>阿姆斯特丹</span>19:20</div>
									<div class="airport"><span>阿姆斯特丹</span>21:00</div>
									<div class="airport"><span>罗马</span>23:10</div>
								</div>
							</div>
							<div class="com_flightInfo">
								...
								<div class="ibWrap">
									<div class="">荷兰皇家航空</div>
									<div class="">东方航空</div>
									<div class="">25h30m</div>
									<div class="">2次中转</div>
								</div>
								<div class="flex-row-start-between">
									<div class="airport"><span>卡坦尼亚</span>16:25</div>
									<div class="airport"><span>阿姆斯特丹</span>19:30</div>
									<div class="airport"><span>阿姆斯特丹</span>21:20</div>
									<div class="airport"><span>上海</span>14:55+1</div>
									<div class="airport"><span>上海</span>20:25</div>
									<div class="airport"><span>成都</span>23:55</div>
								</div>
							</div>
						</div>
					</div>
					<div class="swiper-slide">
						...
						<div class="autoWrapper">
							<div class="com_flightInfo">
								...
								<div class="flex-row-start-between">
									<div class="airport"><span>上海</span>09:50</div>
									<div class="airport"><span>苏黎世</span>15:40</div>
									<div class="airport"><span>苏黎世</span>17:40</div>
									<div class="airport"><span>罗马</span>19:10</div>
								</div>
							</div>
							<div class="com_flightInfo">
								<div class="voyage">回程</div>
								...
								<div class="flex-row-start-between">
									<div class="airport"><span>卡坦尼亚</span>14:55</div>
									<div class="airport"><span>慕尼黑</span>17:10</div>
									<div class="airport"><span>慕尼黑</span>22:00</div>
									<div class="airport"><span>上海</span>15:55+1</div>
								</div>
							</div>
						</div>
					</div>
					<div class="swiper-slide">
						...
						<div class="autoWrapper">
							<div class="com_flightInfo">
								...
								<div class="ibWrap">
									<div class="">瑞士航空</div>
									<div class="">13h20m</div>
									<div class="">1次中转</div>
								</div>
								<div class="flex-row-start-between">
									<div class="airport"><span>北京</span>06:45</div>
									<div class="airport"><span>苏黎世</span>10:40</div>
									<div class="airport"><span>苏黎世</span>12:30</div>
									<div class="airport"><span>罗马</span>14:05</div>
								</div>
							</div>
							<div class="com_flightInfo">
								<div class="voyage">回程</div>
								<div class="ibWrap">
									<div class="">汉莎航空</div>
									<div class="">15h15m</div>
									<div class="">1次中转</div>
								</div>
								<div class="flex-row-start-between">
									<div class="airport"><span>卡坦尼亚</span>14:55</div>
									<div class="airport"><span>慕尼黑</span>17:10</div>
									<div class="airport"><span>慕尼黑</span>19:30</div>
									<div class="airport"><span>北京</span>12:10+1</div>
								</div>
							</div>
						</div>
					</div>
					<div class="swiper-slide">
						...
						<div class="autoWrapper">
							<div class="com_flightInfo">
								...
								<div class="flex-row-start-between">
									<div class="airport"><span>广州</span>23:10</div>
									<div class="airport"><span>伊斯坦布尔</span>06:05+1</div>
									<div class="airport"><span>伊斯坦布尔</span>09:20</div>
									<div class="airport"><span>罗马</span>10:20</div>
								</div>
							</div>
							<div class="com_flightInfo">
								<div class="voyage">回程</div>
								...
								<div class="flex-row-start-between">
									<div class="airport"><span>卡坦尼亚</span>15:50</div>
									<div class="airport"><span>伊斯坦布尔</span>20:25</div>
									<div class="airport"><span>伊斯坦布尔</span>02:15</div>
									<div class="airport"><span>广州</span>16:55</div>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="autoWrapper">
							...
							<div class="com_flightInfo">
								...
								<div class="flex-row-start-between">
									...
									<div class="airport"><span>香港</span>16:30+1</div>
								</div>
							</div>
						</div>
					</div>
