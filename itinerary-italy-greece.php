...
<html>
	<?php 
	$pageName="itinerary-italy-greece";
	...
	$itineraryName="地中海完美假期风光之旅";
	$itineraryPrice="￥21,900起";
...
?>
	...
	<body data-spy="scroll" data-target="#travelPlusNav">
		...
		<!-- Image -->
		<div class="imagesWrap" style="background:url(img/itinerary/billboard/Italy-Greece.jpg)  center center no-repeat;
			...
			<div class="site">
				<div class="tourInfo">
					...
					<div class="transparentTxt">
						...
						<div class="tourName">地中海完美假期风光之旅</div>
		...
		<div class="site">
			...
			<div class="itineraryIntro section">
				...
				<div class="itineraryMap">
					<img src="img/itinerary/map/italy-greece.jpg" />
				</div>
				<div class="initialScreen">
					<div class="com_itinerary_summary">
						...
						<div class="itinerary_daily_item">
							<div class="itinerary_daily_title">
								<div class="itemCircle"></div>
								<label>第4天</label><span>罗马观光游</span>
							</div>
							<div class="itinerary_daily_detail">
								<ul>
									<li>在罗马广场遗址稍作停留</li>
						...
						<div class="itinerary_daily_item">
							<div class="itinerary_daily_title">
								<div class="itemCircle"></div>
								<label>第5天</label><span>罗马自由行</span>
							</div>
						</div>
						<div class="itinerary_daily_item">
							<div class="itinerary_daily_title">
								<div class="itemCircle"></div>
								<label>第6天</label><span>搭乘航班前往希腊的纳夫普利翁，途经科林斯运河</span>
							</div>
						</div>
						<div class="itinerary_daily_item">
							<div class="itinerary_daily_title">
								<div class="itemCircle"></div>
								<label>第7天</label><span>埃皮达鲁斯和迈锡尼观光游</span>
							</div>
							<div class="itinerary_daily_detail">
								<ul>
									<li>参观希腊圆形露天剧场</li>
				...
				<div class="swiper-wrapper">
					...
					<div class="swiper-slide">
						<div class="swiperBgWrap">
							...
							<div class="hotelIntro">
								<div class="transparentBg"></div>
								<div class="transparentTxt">Best Western Premier Hotel Royal Santin贝斯特韦斯特皇家圣缇纳大酒店</div>
							</div>
						</div>
